...
public class RabbitConfig {
    public static final String QUEUE_NAME = "scheduleQueue";
    public static final String QUEUE_EXCHANGE = "schedule_service_exchange";
    public static final String QUEUE_KEY = "schedule_service_key";
    @Bean
